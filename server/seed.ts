...
const jamalpurData = [
  {
    ...
    unions: [
      { name: "jamalpur-sadar-union", nameBn: "জামালপুর সদর" },
      { name: "kendua", nameBn: "কেন্দুয়া" },
      { name: "sharifpur", nameBn: "শরীফপুর" },
      { name: "lakshmirchar", nameBn: "লক্ষ্মীরচর" },
      { name: "tulshirchar", nameBn: "তুলশীরচর" },
      { name: "itail", nameBn: "ইটাইল" },
      { name: "narundi", nameBn: "নরুন্দি" },
      { name: "ghoradhap", nameBn: "ঘোড়াধাপ" },
      { name: "banshchara", nameBn: "বাঁশচড়া" },
      { name: "ranagachha", nameBn: "রানাগাছা" },
      { name: "shripur", nameBn: "শ্রীপুর" },
      { name: "shahbazpur", nameBn: "শাহবাজপুর" },
      { name: "titpalla", nameBn: "তিতপল্লা" },
      { name: "mesta", nameBn: "মেষ্টা" },
      { name: "digpait", nameBn: "দিগপাইত" },
